...
const About = () => {
    ...
    return (
        <div id='about' className={styles.about_container}>
            ...
            <p className={styles.coment} >Desenvolvedor apaixonado por tecnologia, sempre em busca de desafios e aprendizado contínuo.
                <br/> Atuo em comunidades de programação, trocando feedbacks e compartilhando conhecimento para crescer junto com outros profissionais. <br/> Pronto para contribuir de forma significativa em qualquer equipe!</p>
